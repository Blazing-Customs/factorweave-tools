...
pub struct AlertsRulesPostRequest {
    #[serde(rename = "name")]
    pub name: String,
...
impl AlertsRulesPostRequest {
    pub fn new(name: String, indicator: Indicator, condition: Condition, value: f64) -> AlertsRulesPostRequest {
