...
// APIClient manages communication with the Factor Weave API API v1.0.0
...
type APIClient struct {
	...
	DerivedAnalyticsAPI *DerivedAnalyticsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DerivedAnalyticsAPI = (*DerivedAnalyticsAPIService)(&c.common)
