...
# Unit tests for Factorweave::UsageApi
...
describe 'UsageApi' do
  ...
  describe 'test an instance of UsageApi' do
    it 'should create an instance of UsageApi' do
      expect(@api_instance).to be_instance_of(Factorweave::UsageApi)
    end
  end

  # unit tests for recent_activity_get
  # Your last 50 API calls
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'recent_activity_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for usage_get
  # Today + month-to-date stats
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'usage_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
