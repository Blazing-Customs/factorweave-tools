...
class LabelsApi {
  ...
  Future<Response> labelsTickerGetWithHttpInfo(String ticker,) async {
    // ignore: prefer_const_declarations
    final path = r'/labels/{ticker}'
  ...
  /// * [String] ticker (required):
  ///   Uppercase US ticker symbol.
  Future<void> labelsTickerGet(String ticker,) async {
    final response = await labelsTickerGetWithHttpInfo(ticker,);
